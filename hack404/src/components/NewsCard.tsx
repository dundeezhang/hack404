...
const NewsCard = ({ article }: { article?: Article }) => {
  return (
    <div className="relative bg-white w-[300px] rounded-3xl shadow-md text-xl">
      <div className="relative w-[300px] h-[250px]">
        ...
        <div className="absolute bottom-0 w-full z-20 bg-gradient-to-t from-black/70 to-transparent px-4 py-2">
          <h1 className="text-white text-3xl">Title title title title title</h1>
        </div>
      </div>
      ...
      <div className="p-3">
        <div className="flex flex-row justify-between">
          <div className="flex flex-row gap-3 h-[50] my-auto">
            ...
            <h2 className="my-auto text-[#22333B]">First Last</h2>
          </div>
          {/* <div className="flex flex-row justify-between"> */}
          <div className="flex flex-row gap-3 w-1/2 justify-end">
            <FontAwesomeIcon
              ...
              color="#22333B"
            />
            <p className="text-[#22333B] my-auto text-sm">8 mins ago</p>
          </div>
        </div>
        {/* </div> */}
